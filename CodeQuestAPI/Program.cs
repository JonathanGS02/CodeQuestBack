...
using CodeQuest.Repository.Services.Repository;
...
builder.Services.AddScoped<IGeralPersist, GeralPersistRepository>();
...
builder.Services.AddScoped<IQuestaoTopicoService, QuestaoTopicoRepository>();
